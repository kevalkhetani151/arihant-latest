...
const ContactUs = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 via-brand-blue-50 to-brand-blue-50 min-h-screen text-gray-900 font-sans">
     ...
     <section class="bg-slate-950 text-slate-100 py-24 px-6 md:px-12 lg:px-20 font-sans">
  <!-- Section Header -->
  <div class="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-16 border-b border-slate-800 pb-10">
    <div>
      <span class="text-xs uppercase tracking-widest text-indigo-400 font-semibold mb-3 block">Our Core Values</span>
      <h2 class="text-3xl md:text-5xl font-light tracking-tight text-white leading-tight">
        The Foundation of <span class="font-semibold underline decoration-indigo-500/50 underline-offset-8">Everything We Do</span>
      </h2>
    </div>
    <p class="text-slate-400 max-w-md text-sm md:text-base">
  ...
  <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <!-- Ethics -->
    <div class="group relative p-8 bg-slate-900/60 border border-slate-800 hover:border-indigo-500/50 rounded-2xl transition-all duration-300 hover:-translate-y-1">
      <span class="text-xs font-mono text-indigo-400 mb-4 block">01 / INTEGRITY</span>
      <h3 class="text-2xl font-medium text-white mb-3">Ethics</h3>
      <p class="text-slate-400 text-sm leading-relaxed mb-6">
        Radical transparency and honest partnership. We prioritize long-term trust over short-term gain, giving you straight answers even when they are tough to hear.
      </p>
      <div class="text-xs text-slate-500 font-mono uppercase tracking-wider border-t border-slate-800/80 pt-4">
    ...
    <!-- Quality -->
    <div class="group relative p-8 bg-slate-900/60 border border-slate-800 hover:border-indigo-500/50 rounded-2xl transition-all duration-300 hover:-translate-y-1">
      <span class="text-xs font-mono text-indigo-400 mb-4 block">02 / EXCELLENCE</span>
      <h3 class="text-2xl font-medium text-white mb-3">Quality</h3>
      <p class="text-slate-400 text-sm leading-relaxed mb-6">
        Crafted without shortcuts. Every pixel, system architecture, and client touchpoint undergoes rigorous review to ensure lasting endurance and performance.
      </p>
      <div class="text-xs text-slate-500 font-mono uppercase tracking-wider border-t border-slate-800/80 pt-4">
    ...
    <!-- Proactive -->
    <div class="group relative p-8 bg-slate-900/60 border border-slate-800 hover:border-indigo-500/50 rounded-2xl transition-all duration-300 hover:-translate-y-1">
      <span class="text-xs font-mono text-indigo-400 mb-4 block">03 / FORESIGHT</span>
      <h3 class="text-2xl font-medium text-white mb-3">Proactive</h3>
      <p class="text-slate-400 text-sm leading-relaxed mb-6">
        We don't wait for roadblocks to appear. We continuously audit, anticipate future scale needs, and solve challenges before they ever touch your operations.
      </p>
      <div class="text-xs text-slate-500 font-mono uppercase tracking-wider border-t border-slate-800/80 pt-4">
    ...
    <!-- Responsiveness -->
    <div class="group relative p-8 bg-slate-900/60 border border-slate-800 hover:border-indigo-500/50 rounded-2xl transition-all duration-300 hover:-translate-y-1">
      <span class="text-xs font-mono text-indigo-400 mb-4 block">04 / SPEED & CARE</span>
      <h3 class="text-2xl font-medium text-white mb-3">Responsiveness</h3>
      <p class="text-slate-400 text-sm leading-relaxed mb-6">
        Communication is our priority. You never have to guess project status or wait days for an answer — direct access and swift action are guaranteed.
      </p>
      <div class="text-xs text-slate-500 font-mono uppercase tracking-wider border-t border-slate-800/80 pt-4">
